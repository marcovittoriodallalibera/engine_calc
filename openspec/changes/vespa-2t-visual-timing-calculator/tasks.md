...
- [ ] 15.3 Publish `v0.1.0-preview.3` as an explicitly unsigned and non-notarised GitHub pre-release, never as the stable `latest` release; retain the failed `preview.1` and `preview.2` tags as audit evidence without releases
